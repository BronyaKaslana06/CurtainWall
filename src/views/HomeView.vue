...
<template>
  <div style="position: fixed; right: 10px; top: 15px; z-index: 1000;">
    <el-button type="primary" @click="goHome" style="position: absolute; right: 0; top: 0;">返回主页</el-button>
  </div>
  <div class="home">
    <!-- 背景图片 -->
  ...
  <div v-if="option === '0'" class="quake_info">
    ...
    <div class="text_1_2">
      同济大学地震⼯程馆是当前世界规模最大、由四座振动台组合而成的大型综合试验室，通体由石材幕墙作为外维护结构。使用年限十余年，表面出现不少裂缝损伤。我们通过无人机对地震馆进行三维模型数据采集和局部图像矩阵拍摄，并将局部图像进行批量裂缝检测，将检测结果映射到三维模型上，供用户查看。系统提供如下功能：<br />▪
